#!/usr/bin/env python3
"""
从 config/platform-figma-list.json 解析站点 → fileKey / cnName / enName。
...
DEFAULT_PLATFORM_LIST = CONFIG_DIR / "platform-figma-list.json"
DEFAULT_EN_MAP_PATHS = [
    CONFIG_DIR / "haobo-style.json",
    CONFIG_DIR / "platform-site-en-map.json",
]

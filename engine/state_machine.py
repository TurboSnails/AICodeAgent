...
VALID_TRANSITIONS = {
    ...
    State.PLANNING: [State.DEBATING, State.CODING, State.WAITING_CLARIFICATION, State.DIRECT_ANSWER, State.ARCHITECT_PLANNING, State.CONSENSUS, State.CODEX_REVIEW, State.CANCELLED],
    State.WAITING_CLARIFICATION: [State.PENDING, State.CANCELLED],
    State.DEBATING: [State.CONSENSUS, State.CORRECTING, State.CANCELLED],
    State.CONSENSUS: [State.ARCHITECT_PLANNING, State.WAITING_GATE, State.CODEX_REVIEW, State.CANCELLED],
    State.ARCHITECT_PLANNING: [State.CODING, State.COMPLETED, State.WAITING_CLARIFICATION, State.CANCELLED],
    ...
    State.BUILDING: [State.SELF_REVIEW, State.CODEX_REVIEW, State.ARCHITECT_REVIEW, State.RED_TEAM_REVIEW, State.REQUIREMENT_REVIEW, State.GIT_COMMITTING, State.CORRECTING, State.FAILED, State.CANCELLED],
